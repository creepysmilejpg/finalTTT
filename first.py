...
label1 = Label(root, text="Player 1: X", font="times 15 bold")
label1.grid(row=0, column=1)

label2 = Label(root, text="Player 2: O", font="times 15 bold")
label2.grid(row=0, column=3)

button1 = Button(root, width=20, height=10, command=lambda: define_sign(1))
button1.grid(row=1, column=1)

button2 = Button(root, width=20, height=10, command=lambda: define_sign(2))
button2.grid(row=1, column=2)

button3 = Button(root, width=20, height=10, command=lambda: define_sign(3))
button3.grid(row=1, column=3)

button4 = Button(root, width=20, height=10, command=lambda: define_sign(4))
button4.grid(row=4, column=1)

button5 = Button(root, width=20, height=10, command=lambda: define_sign(5))
button5.grid(row=4, column=2)

button6 = Button(root, width=20, height=10, command=lambda: define_sign(6))
button6.grid(row=4, column=3)

button7 = Button(root, width=20, height=10, command=lambda: define_sign(7))
button7.grid(row=8, column=1)

button8 = Button(root, width=20, height=10, command=lambda: define_sign(8))
button8.grid(row=8, column=2)

button9 = Button(root, width=20, height=10, command=lambda: define_sign(9))
